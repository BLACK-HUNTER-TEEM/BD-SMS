...
\033[1;37m
\033[1;31m---------------------------------------
\033[1;35mCREATED BY : \033[33mBD JAHIED
\033[1;35mGROUP      : \033[1;33mBLACK HUNTER TEAM
\033[1;35mFACEBOOK   : \033[1;33mZAHID HUSSAIN
...
def sms_bombing():
    ...
    print ""
    print "\033[1;31m[~] \033[1;33mSOON \033[1;32m"+str(limit)+" \033[1;33mSMS WILL BE SEND \033[1;31m[~]"
...
def intro():
    ...
    print ""
    user_choise = raw_input("\033[1;34'BH-TEAM\033[1;31m>>  ")
    if user_choise == "1":
       sms_bombing()
    elif user_choise == "2":
         os.system('xdg-open https://youtube.com/channel/UCzpqRlRaLASqwsWvsPuCdwQ')
